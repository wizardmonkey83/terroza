...
from .views import load_send_challenge_request, load_challenge_page, load_past_challenges, load_challenge_overview, accept_challenge_request, remove_challenge_request, load_pending_challenge_requests
